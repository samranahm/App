...
${amount} para ${merchant} - ${date}`,
    ...
    subscription: {
        ...
        subscriptionSettings: {
            ...
            collectBillingDescription: 'Los espacios de trabajo Collect se facturan mensualmente por miembro, sin compromiso anual.',
            pricing: 'Precios',
            collectPricing: ({price}: {price: string}) => `${price} por miembro al mes`,
        },
