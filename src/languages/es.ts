...
const translations = {
    common: {
        ...
        error: {
            ...
            phoneNumber: `Por favor, introduce un número de teléfono completo (p. ej. ${CONST.EXAMPLE_PHONE_NUMBER})`,
...
${amount} para ${merchant} - ${date}`,
    ...
    search: {
        ...
        filters: {
            ...
            reportField: ({name, value}: OptionalParam<ReportFieldParams>) => `${name} es ${value}`,
        },
        has: 'Tiene',
        groupBy: 'Agrupar por',
        moneyRequestReport: {
